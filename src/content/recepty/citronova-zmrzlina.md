---
title: "Citronová zmrzlina"
cislo: 3
typ: "tocena"
obtiznost: "zacatecnik"
tuk_pct: 4.1
pac: 27
serv_teplota: "−9 až −11 °C"
varka_kg: 10
tags:
  - smetanova
  - ovoce
...
| [Glukóza (sušený sirup, prášek)](/ingredience/glukoza-suseny-sirup/)                        | 150        | 1,5 %     |
| [MEC3 Natura 50](/ingredience/mec3-natura-50/)                                              | 50         | 0,5 %     |
| **PO PASTERACI / DO VYCHLAZENÉ SMĚSI**                                                      |            |           |
| [Tvaroh (polotučný, 4 %)](/ingredience/tvaroh/)                                             | 1 000      | 10,0 %    |
| [Citronová šťáva (čerstvá)](/ingredience/citronova-stava/) Přidávat postupně a podle chuti. | 800        | 8,0 %     |
...
| Složka     | Výpočet / odhad                                          | Hodnota            |
| ---------- | -------------------------------------------------------- | ------------------ |
| **Tuk**    | mléko 5 800×0,035 + smetana 500×0,33 + tvaroh 1 000×0,04 | ~408 g → **4,1 %** |
| **MSNF**   | mléko + SOM + tvaroh + smetana                           | **~11 %**          |
| **Sušina** | mléčná sušina + cukry + citronová šťáva + stabilizátor   | **~30 %**          |
| **PAC**    | sacharóza + dextróza + glukóza + laktóza                 | **~27**            |
