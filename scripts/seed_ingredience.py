...
INGREDIENCE: list[tuple] = [
    ...
    (
        ...
        None,
        "10–30 % m/m",
        ["smetana ke šlehání", "smetana 33 %", "smetana 35 %", "heavy cream", "whipping cream"],
        ["tuky-ve-zmrzline"],
        ["smetana", "tuk", "mlecny-tuk"],
        "Hlavní zdroj mléčného tuku. Jedna karta pro všechny tučnosti (30–40 %) — v tabulce najdeš sušinu, MSNF a laktózu pro každou z nich. Nepoužívat smetanu s rostlinnými ztužovači.",
    ),
    (
        "vajecny-zloutek",
